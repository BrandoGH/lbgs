...
// #define CONFIGURE_ARGS " '--disable-nls' '--with-openssl' '--with-zlib' '--without-icu' '--with-lz4' '--without-readline' '--without-libxml' '--without-libxslt' '--without-python' '--disable-silent-rules' '--verbose' '--disable-shared' '--enable-static' '--prefix=/home/liubin/vcpkg/installed/x64-linux' '--bindir=${prefix}/tools/libpq/bin' '--sbindir=${prefix}/tools/libpq/sbin' '--libdir=${prefix}/lib' '--mandir=${prefix}/share/libpq' '--docdir=${prefix}/share/libpq' '--datarootdir=${prefix}/share/libpq' 'CC=/usr/bin/cc' 'CFLAGS=-fPIC -O3' 'LDFLAGS=-L/home/liubin/vcpkg/installed/x64-linux/lib' 'CPPFLAGS=-DNDEBUG' 'CXX=/usr/bin/c++' 'CXXFLAGS=-fPIC -O3' 'PKG_CONFIG=/bin/pkg-config' 'PKG_CONFIG_PATH=/home/liubin/vcpkg/installed/x64-linux/lib/pkgconfig/:/home/liubin/vcpkg/installed/x64-linux/share/pkgconfig/'"
...
#define PG_VERSION_STR "PostgreSQL 14.4 on x86_64-pc-linux-gnu, compiled by cc (Debian 8.3.0-6) 8.3.0, 64-bit"
