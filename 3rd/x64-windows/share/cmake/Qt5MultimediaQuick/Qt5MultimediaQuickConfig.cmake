...
macro(_populate_MultimediaQuick_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    if("${Configuration}" STREQUAL "DEBUG") # 1
        set(imported_location "${_qt5MultimediaQuick_install_prefix}/debug/bin/${LIB_LOCATION}")
    else()
    ...
    if("${Configuration}" STREQUAL "DEBUG")
        set(imported_implib "${_qt5MultimediaQuick_install_prefix}/debug/lib/${IMPLIB_LOCATION}")
    else()
...
if (NOT TARGET Qt5::MultimediaQuick)
    ...
    set(Qt5MultimediaQuick_PRIVATE_INCLUDE_DIRS
        "${_qt5MultimediaQuick_install_prefix}/include/qt5/QtMultimediaQuick/5.15.2"
        "${_qt5MultimediaQuick_install_prefix}/include/qt5/QtMultimediaQuick/5.15.2/QtMultimediaQuick"
    )
    ...
    if (EXISTS
        "${_qt5MultimediaQuick_install_prefix}/debug/bin/Qt5MultimediaQuickd.dll"
      AND EXISTS
        "${_qt5MultimediaQuick_install_prefix}/debug/lib/Qt5MultimediaQuickd.lib" )
